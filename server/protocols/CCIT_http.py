...
RESPONSES = {
    FlagStatus.QUEUED: ['timeout'],
    FlagStatus.ACCEPTED: ['Accepted', 'congrat', 'flag points'],
    FlagStatus.REJECTED: ['flag is your own', 'flag from nop team', 'invalid flag', 'flag too old','flag already claimed'],
}
